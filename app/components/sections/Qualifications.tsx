            ...
            <TabsContent value="experience" className="rounded-lg border">
                <ol className="relative ml-10 mr-6 border-s sm:mr-10">
                    <li className="relative ml-10 py-4">
                        ...
                        <ul className="ml-4 grid list-outside list-disc gap-1">
                            <li className="text-sm text-muted transition-colors duration-200">
                                ...
                                statuses and track parcels through guidance from
                                colleagues, fostering a supportive environment
                            </li>
                            <li className="text-sm text-muted transition-colors duration-200">
                                Demonstrated increased autonomy in encoding
                                tasks by independently managing delivery updates
                                and handling complex tracking issues through
                                enhanced familiarity with the system.
                            </li>
                            <li className="text-sm text-muted transition-colors duration-200">
                                Enhanced problem-solving skills and showcased
                                resilience by addressing challenges with faded
                                barcodes and illegible handwriting through
                                innovative strategies while maintaining
                                productivity despite recurring technology
                                issues.
                            </li>
                        </ul>
                    </li>
                    <li className="relative ml-10 py-4">
                        ...
                        <ul className="ml-4 grid list-outside list-disc gap-1">
                            <li className="text-sm text-muted transition-colors duration-200">
                                Handled quality assurance on the microcontroller
                                production line, ensuring 100% compliance with
                                standards and resolving production issues
                                throughout the internship.
                            </li>
                            <li className="text-sm text-muted transition-colors duration-200">
                                Monitored microcontroller handling, ensuring
                                careful processing to meet daily quotas while
                                maintaining production quality standards.
                            </li>
                            <li className="text-sm text-muted transition-colors duration-200">
                                Learned the 5S methodology through the lecture
                                provided and applied it to streamline quality
                                assurance processes for microcontrollers,
                                enhancing workplace organization and efficiency.
                            </li>
                        </ul>
                    </li>
                </ol>
            ...
            <TabsContent value="education" className="rounded-lg border">
                <ol className="relative ml-10 mr-6 border-s sm:mr-10">
                    <li className="relative ml-10 py-4">
                        ...
                        <ul className="ml-4 grid list-outside list-disc gap-1">
                            <li className="text-sm text-muted transition-colors duration-200">
                                Earned Cum Laude honors for academic excellence,
                                graduating with a grade of 1.21/1.00
                            </li>
                            <li className="text-sm text-muted transition-colors duration-200">
                    ...
                    <li className="relative ml-10 py-4">
                        ...
                        <ul className="ml-4 grid list-outside list-disc gap-1">
                            <li className="text-sm text-muted transition-colors duration-200">
                                ...
                                Technology (ICT) – Computer Programming
                            </li>
                        </ul>
                    </li>
                </ol>
